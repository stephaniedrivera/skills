...
3. Query Ask Solo per claim (or per closely related cluster of claims — batch
...
5. Cross-check against screenshots/UI if the draft references specific labels —
   ...
   code-confirmed-only.
6. Do not silently edit the draft. For each contradicted or unverifiable claim,
